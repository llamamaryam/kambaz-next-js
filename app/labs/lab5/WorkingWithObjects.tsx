...
export default function WorkingWithObjects() {
  ...
  return (
    <div id="wd-working-with-objects">
      ...
      <a id="wd-retrieve-module" className="btn btn-secondary"
         href={`${MODULE_API_URL}`}>Get Module</a><hr/>
      ...
      <input className="form-control w-75 mb-2" id="wd-assignment-score" type="number"
      ...
      <a id="wd-update-module-name" className="btn btn-secondary float-end"
         href={`${MODULE_API_URL}/name/${module.name}`}>Update Name</a>
      <input className="form-control w-75 mb-2" id="wd-module-name"
        defaultValue={module.name}
        onChange={(e) => setModule({ ...module, name: e.target.value })} />
      <a id="wd-update-module-description" className="btn btn-secondary float-end"
         href={`${MODULE_API_URL}/description/${module.description}`}>Update Description</a>
